# ──────────────────────────────────────────────────────────────
# Multi-stage build for the kitchen dashboard.
...
LABEL org.opencontainers.image.title="kitchen-dashboard"
LABEL org.opencontainers.image.description="Kitchen wall-panel smart-home dashboard for Home Assistant"
